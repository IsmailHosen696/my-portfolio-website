    ...
    return (
        <div className="sticky left-0 right-0 z-30 top-0 w-full h-16 items-center flex justify-center bg-white dark:bg-gray-900">
            <div className="flex mx-auto sm:px-10 px-2 max-w-screen-2xl items-center justify-between relative w-full">
                ...
                <div style={{ fontFamily: "'Nunito', sans-serif" }} className={`sm:gap-8 gap-3 sm:px-0 px-10 flex items-start sm:bg-auto bg-white dark:bg-gray-900 sm:items-center sm:flex-row flex-col absolute top-10 sm:w-auto left-0 sm:static w-full ${isMenuBarOpen ? "sm:visible visible" : "sm:visible invisible"}`}>
