            ...
            <div className="w-full h-full flex items-center justify-center">
                <div className="lg:w-7/12 w-full lg:px-0 px-2 mb-10 sm:px-10 max-w-screen-2xl flex flex-col gap-5 mx-auto ">
                    ...
                    <div className="flex items-center gap-5 flex-row">
                        {project?.hostedURL && <a target="_ismail" title="view live view of the project" href={`${project?.hostedURL}`} ><ExternalLinkIcon className="w-5 h-5 text-gray-700 dark:text-gray-300" /></a>}
                        <a target="_ismail" href={`${project?.gitRepoURL}`} title="view git repo"><LinkIcon className="w-5 h-5 text-gray-700 dark:text-gray-300" /></a>
                    </div>
